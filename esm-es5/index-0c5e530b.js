...
var NAMESPACE = 'amwell-visit-console';
var scopeId;
var contentRef;
var hostTagName;
...
var attachStyles = function (hostRef) {
    ...
    var scopeId = addStyle((supportsShadow && elm.shadowRoot)
        ? elm.shadowRoot
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, import('./shadow-css-d191a97c.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 3:
                style_1 = _a.sent();
                _a.label = 4;
            case 4:
...
var patchEsm = function () {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-63363a96.js').then(function () {
...
var patchBrowser = function () {
    ...
    }
    {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-8488c424.js').then(function () { return opts; });
        }
    }
