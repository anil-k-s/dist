...
const index = require('./index-085d988e.js');
const _commonjsHelpers = require('./_commonjsHelpers-72d386ba.js');

var compareVersions = _commonjsHelpers.createCommonjsModule(function (module, exports) {
/* global define */
...
var get_object = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
_commonjsHelpers.unwrapExports(get_object);

var replace_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const replace = _commonjsHelpers.unwrapExports(replace_1);
 ...
 * prior written authorization from American Well.
 */
const DrawerHeader = (props) => (index.h("div", { class: "visit-drawer-header" },
    index.h("div", { class: "visit-drawer-title" }, props.name),
    index.h("div", { class: "visit-drawer-close-button", onClick: (e) => props.onCloseClicked(e) },
        index.h("svg", { width: "24", height: "24", viewBox: "0 0 24 24" },
            index.h("path", { id: "a", d: "M10.943 12L4 5.057 5.057 4 12 10.943 18.943 4 20 5.057 13.057 12 20 18.943 18.943 20 12 13.057 5.057 20 4 18.943 10.943 12z" })))));
 ...
 * prior written authorization from American Well.
 */
const DrawerButton = (props, children) => (index.h("div", { class: { 'drawer-button': true, [props.className]: true, 'selected': props.selected }, onClick: (e) => props.onClick(e) },
    index.h("div", { class: "drawer-icon" }, children),
    index.h("div", { class: "drawer-button-label" }, props.name),
    props.showNotificationDot && index.h("div", { class: "notification-dot" })));
 ...
 * prior written authorization from American Well.
 */
const NotesIcon = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32" },
    index.h("g", { fill: "none", "fill-rule": "nonzero" },
        index.h("g", { "stroke-width": "1.8", transform: "translate(6 1)" },
            index.h("path", { d: "M16.486 1.74h3.066c.8 0 1.448.648 1.448 1.448v25.363c0 .8-.648 1.449-1.448 1.449H1.448C.648 30 0 29.351 0 28.55V3.189c0-.8.648-1.449 1.448-1.449h3.44" }),
            index.h("rect", { width: "10.248", height: "4.548", x: "5.376", y: ".9", rx: "1.449" })),
        index.h("rect", { width: "11", height: "2", x: "11", y: "12", rx: "1" }),
        index.h("rect", { width: "11", height: "2", x: "11", y: "17", rx: "1" }),
        index.h("rect", { width: "11", height: "2", x: "11", y: "22", rx: "1" }))));
 ...
 * prior written authorization from American Well.
 */
const InviteIcon = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32" },
    index.h("g", { fill: "none", "stroke-width": "2" },
        index.h("path", { "stroke-linecap": "round", d: "M31 13h-7M27.5 9.5v7" }),
        index.h("path", { d: "M15.032 3c4.345 0 7.775 6.185 3.934 12.044-1.442 2.2-1.22 3.84 4.521 5.435 2.626.73 3.513 1.325 3.513 3.268V27a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-3.253c0-1.943.887-2.539 3.513-3.268 5.742-1.595 5.963-3.235 4.52-5.435C7.194 9.185 10.624 3 14.969 3h.064z" }))));
 ...
 * prior written authorization from American Well.
 */
const Modal = (props) => (index.h("div", { class: { "visit-console-modal-container": true, "hidden": !props.isOpen } },
    index.h("div", { class: "visit-console-modal" },
        index.h("div", { class: "visit-console-modal-header" },
            props.title,
            props.closeOnClick &&
                index.h("button", { onClick: (e) => props.closeOnClick(e) })),
        index.h("div", { class: "visit-console-modal-body" },
            index.h("div", { class: "visit-console-modal-content", innerHTML: props.message }),
            index.h("div", { class: "visit-console-modal-buttons" },
                props.button1Text && index.h("button", { onClick: (e) => props.button1OnClick && props.button1OnClick(e) }, props.button1Text),
                props.button2Text && index.h("button", { onClick: (e) => props.button2OnClick && props.button2OnClick(e) }, props.button2Text))))));
...
const VisitConsole = class {
    ...
    render() {
        ...
        return (index.h("div", { class: {
            ...
            }, dir: document.documentElement.dir }, index.h("div", { class: "visit-header" }, index.h("div", { class: "logo-container" }, index.h("slot", { name: "logo" }))), index.h("div", { class: "visit-timer" }, this.visit && !this.visit.hidePatientTimer && this.timeRemaining &&
            index.h("span", null, this.timeRemaining)), index.h("div", { class: "visit-body" }, index.h("div", { class: { 'visit-sidebar': true, 'side-shadow': !this.isDrawerOpen } }, showChat &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_chat_button_text, className: 'chat-button', selected: isChatOpen, showNotificationDot: this.showChatNotification, onClick: () => this.toggleDrawer('chat') }, index.h(ChatIcon, null)), showNotes &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_notes_button_text, className: 'notes-button', selected: isNotesOpen, showNotificationDot: this.showNotesNotification, onClick: () => this.toggleDrawer('notes') }, index.h(NotesIcon, null)), showInvite &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_invite_button_text, className: 'invite-button', selected: isInviteOpen, onClick: () => this.toggleDrawer('invite') }, index.h(InviteIcon, null)), showTytoDrawer &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_drawer_tyto_button_text, className: 'tyto-button', selected: isTytoOpen, onClick: () => this.toggleDrawer('tyto') }, index.h(TytoIcon, null))), index.h("div", { class: "bottom-drawer" }, index.h("div", { class: "bottom-drawer-button", onClick: () => this.isBottomDrawerOpen = !this.isBottomDrawerOpen }), index.h("div", { class: "bottom-drawer-content" }, index.h("div", { class: "bottom-drawer-buttons" }, showChat &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_chat_button_text, className: 'chat-button', showNotificationDot: this.showChatNotification, onClick: () => this.toggleDrawer('chat') }, index.h(ChatIcon, null)), showNotes &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_notes_button_text, className: 'notes-button', showNotificationDot: this.showNotesNotification, onClick: () => this.toggleDrawer('notes') }, index.h(NotesIcon, null)), showInvite &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_invite_button_text, className: 'invite-button', onClick: () => this.toggleDrawer('invite') }, index.h(InviteIcon, null)), index.h(DrawerButton, { name: this.messages.amwell_visit_console_reload_button_text, className: 'reload-button', onClick: () => this.videoConsole.refresh() }, index.h(ReloadIcon, null)), showTytoDrawer &&
            index.h(DrawerButton, { name: this.messages.amwell_visit_console_drawer_tyto_button_text, className: 'tyto-button', onClick: () => this.toggleDrawer('tyto') }, index.h(TytoIcon, null))))), index.h("div", { class: { 'visit-drawer': true, 'side-shadow': true, 'hidden': !this.isDrawerOpen } }, index.h("div", { class: { 'drawer-content': true, 'chat-drawer': true, 'hidden': this.activeDrawerName !== 'chat' } }, index.h(DrawerHeader, { onCloseClicked: () => this.isDrawerOpen = false, name: this.messages.amwell_visit_console_drawer_chat_title }), index.h("amwell-chat-window", { ref: (el) => this.chatWindow = el })), index.h("div", { class: { 'drawer-content': true, 'notes-drawer': true, 'hidden': this.activeDrawerName !== 'notes' } }, index.h(DrawerHeader, { onCloseClicked: () => this.isDrawerOpen = false, name: this.messages.amwell_visit_console_drawer_notes_title }), index.h("amwell-visit-notes", { ref: (el) => this.visitNotes = el })), index.h("div", { class: { 'drawer-content': true, 'invite-drawer': true, 'hidden': this.activeDrawerName !== 'invite' } }, index.h(DrawerHeader, { onCloseClicked: () => this.isDrawerOpen = false, name: this.messages.amwell_visit_console_drawer_invite_title }), index.h("amwell-guest-invite", { ref: (el) => this.guestInvite = el })), index.h("div", { class: { 'drawer-content': true, 'tyto-device': true, 'hidden': this.activeDrawerName !== 'tyto' } }, index.h(DrawerHeader, { onCloseClicked: () => this.isDrawerOpen = false, name: this.messages.amwell_visit_console_drawer_tyto_header_text }), index.h("amwell-tyto-device", { ref: (el) => this.tytoDevice = el }))), index.h("amwell-video-console", { class: "video-console", ref: (el) => this.videoConsole = el })), this.visit && this.visit.longExtensionEntity && this.systemConfiguration &&
            index.h(Modal, { isOpen: this.showVisitExtensionModal, title: this.messages.amwell_visit_console_visit_extension_title, message: replace(this.messages.amwell_visit_console_visit_extension_message, { cost: `<u>${new Intl.NumberFormat(this.locale, { style: 'currency', currency: this.systemConfiguration.currencyCode })
...
exports.amwell_visit_console = VisitConsole;
