...
const tytoWizardScreenType_model = require('./tyto-wizard-screen-type.model-6981777f.js');
...
var redefine = _commonjsHelpers.createCommonjsModule(function (module) {
...
var internalMetadata = _commonjsHelpers.createCommonjsModule(function (module) {
var defineProperty = objectDefineProperty.f;
...
var iterate_1 = _commonjsHelpers.createCommonjsModule(function (module) {
...
var es_weakMap = _commonjsHelpers.createCommonjsModule(function (module) {
...
/** Detect free variable `global` from Node.js. */
var freeGlobal$2 = typeof _commonjsHelpers.commonjsGlobal == 'object' && _commonjsHelpers.commonjsGlobal && _commonjsHelpers.commonjsGlobal.Object === Object && _commonjsHelpers.commonjsGlobal;
...
const AdminMessage = ({ chatItem, i18messages }) => {
    ...
    return (index$1.h("div", { class: { 'chat-item': true, 'admin-message': true, 'admin-message-border': showBorder } },
        title && index$1.h("h3", null, title),
        chatItem.message));
};
 ...
 * prior written authorization from American Well.
 */
const ChatMessage = ({ chatItem, showSubtitle }) => (index$1.h("div", { class: { 'chat-item': true, 'self-message': chatItem.isSelf } },
    index$1.h("div", { class: "chat-item-content" },
        index$1.h("div", { class: "chat-item-bubble" },
            index$1.h("div", { class: "chat-item-message" }, chatItem.message),
            index$1.h("div", { class: "chat-item-tail-outer" },
                index$1.h("div", { class: "chat-item-tail-inner" }))),
        showSubtitle &&
            index$1.h("div", { class: "chat-item-subtitle" },
                !chatItem.isSelf && index$1.h("span", null, chatItem.fullName),
                !chatItem.isSelf && index$1.h("span", null, "\u00A0-\u00A0"),
                index$1.h("span", null, dateFns_50(chatItem.date, 'h:mm A'))))));
...
const ChatWindow = class {
    constructor(hostRef) {
        ...
        this.newMessagesReceived = index$1.createEvent(this, "newMessagesReceived", 7);
    }
    ...
    drawChatItem(chatItem, showSubtitle) {
        if (chatItem.userType === "ADMIN") {
            return index$1.h(AdminMessage, { chatItem: chatItem, i18messages: this.messages });
        }
        return index$1.h(ChatMessage, { chatItem: chatItem, showSubtitle: showSubtitle });
    }
    render() {
        return (index$1.h("div", { class: "chat-window", dir: document.documentElement.dir }, index$1.h("div", { ref: (el) => this.transcript = el, class: { 'transcript': true, 'hidden': this.chatItems.length === 0 }, "data-simplebar-direction": document.documentElement.dir }, index$1.h("div", null, index$1.h("div", { class: "chat-icon-bumper" }, index$1.h(LargeChatIcon, null)), this.drawChatItems(this.chatItems))), index$1.h("div", { class: { 'chat-placeholder': true, 'hidden': this.chatItems.length > 0 } }, index$1.h(LargeChatIcon, null), index$1.h("div", null, this.messages.amwell_chat_window_messages_placeholder)), index$1.h("div", { class: { 'new-message-toast-container': true, 'hidden': !this.showNewMessagesToast } }, index$1.h("div", { onClick: () => this.scrollToBottom(), class: "new-message-toast" }, index$1.h("div", { class: "chevron down" }), index$1.h("div", null, this.messages.amwell_chat_window_new_messages_toast), index$1.h("div", { class: "chevron down" }))), index$1.h("form", null, index$1.h("input", { ref: (el) => this.input = el, type: "text", placeholder: this.messages.amwell_chat_window_input_placeholder }), index$1.h("button", { type: "submit", onClick: (e) => this.sendMessage(e) }, index$1.h(SendIcon, null)))));
    }
...
const GuestInvite = class {
    ...
    render() {
        return (index$1.h("div", { class: "guest-invite", ref: (el) => this.inviteScroll = el, dir: document.documentElement.dir, "data-simplebar-direction": document.documentElement.dir }, index$1.h("div", null, this.invitedGuests.length > 0 &&
            index$1.h("div", { class: "invited-guest-section" }, index$1.h("h3", null, this.messages.amwell_guest_invite_invited_guests_header), index$1.h("div", { class: "invited-guest-names" }, this.invitedGuests.sort((guest1, guest2) => guest1.length - guest2.length).map((guest) => [index$1.h("div", { title: guest, class: "invited-guest-name" }, guest), index$1.h("div", { class: "invited-guest-spacer" })])), index$1.h("div", { class: { "max-invited-message": true, "max-invited": !this.shouldShowInviteSection() } }, this.messages.amwell_guest_invite_invited_max)), this.shouldShowInviteSection() &&
            index$1.h("div", { class: "invite-guest-section" }, index$1.h("div", { class: "invite-guest-subtitle" }, this.messages.amwell_guest_invite_invite_guest_subtitle), index$1.h("div", { class: "invite-inputs" }, this.emails.map((email, index) => index$1.h("div", { key: email.value + index, class: "input-group" }, index$1.h("floating-label-input", { error: email.error, label: this.messages.amwell_guest_invite_input_label, value: email.value, hasFocus: this.focusedIndex === index, handleOnFocus: () => this.focusedIndex = index, handleOnBlur: (e) => this.handleOnEmailBlur(email, e.target.value) }), this.emails.length > 1 &&
                index$1.h("button", { class: "link-like", onClick: (e) => this.removeInput(e, index) }, this.messages.amwell_guest_invite_remove_text)))), this.shouldShowAddMoreButton() &&
                index$1.h("button", { class: "add-another-button link-like", onClick: (e) => this.addInput(e) }, index$1.h("span", { class: "add-another-plus-sign" }, "\u271A"), index$1.h("span", { class: "add-another-text" }, this.messages.amwell_guest_invite_add_another_text)), index$1.h("button", { onClick: (e) => this.handleSendInvites(e), class: { "send-invite-button": true,
                    "pending-invites": this.pendingInvites,
                    "invites-sent": this.invitesSent
                } }, index$1.h("div", null), this.invitesSent
                ?
                    index$1.h("span", null, this.messages.amwell_guest_invite_button_text_pending)
                :
                    index$1.h("span", null, this.messages.amwell_guest_invite_button_text))))));
    }
    static get watchers() { return {
        "visit": ["visitUpdated"]
    }; }
...
const TytoDeviceWizard = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.messages = tytoWizardScreenType_model.defaultMessages;
    ...
    async initialize(sdk, options) {
        ...
        this.sdk.deviceLiveStreamService
            ...
            if (response.devicePairingStatus.toString() === "PAIRED") {
                this.initializeStep = tytoWizardScreenType_model.TytoWizardScreenType.DEVICE_PAIRED;
                this.isTytoDevicePaired = true;
            }
            else {
                this.initializeStep = tytoWizardScreenType_model.TytoWizardScreenType.TYTO_DEVICE_INTAKE;
            }
        })
            .catch(() => {
            this.initializeStep = tytoWizardScreenType_model.TytoWizardScreenType.TYTO_DEVICE_INTAKE;
    ...
    render() {
        return (index$1.h("div", null, index$1.h("tyto-stepper", { sdk: this.sdk, consumer: this.consumer, initializeStep: this.initializeStep, isTytoDevicePaired: this.isTytoDevicePaired })));
    }
...
const VideoConsole = class {
    constructor(hostRef) {
        ...
        this.visitUpdated = index$1.createEvent(this, "visitUpdated", 7);
        this.visitError = index$1.createEvent(this, "visitError", 7);
        this.visitEnd = index$1.createEvent(this, "visitEnd", 7);
    }
    async initialize(sdk, options) {
        this.sdk = sdk;
        this.visit = options.visit;
    ...
    render() {
        return (index$1.h("div", { class: "video-console", ref: (el) => this.container = el, dir: document.documentElement.dir }));
    }
 ...
 * prior written authorization from American Well.
 */
const NotesSection = (props, children) => (index$1.h("div", { ref: props.ref, class: props.class },
    index$1.h("div", { class: "notes-section-header" }, props.title),
    children));
 ...
 * prior written authorization from American Well.
 */
const NotesEntry = (props) => (index$1.h("div", { class: "notes-entry" },
    props.title &&
        index$1.h("h3", null, props.title),
    props.description));
...
const VisitNotes = class {
    constructor(hostRef) {
        ...
        this.newNotesReceived = index$1.createEvent(this, "newNotesReceived", 7);
    }
    async initialize(sdk, options) {
        this.sdk = sdk;
        this.visit = options.visit;
    ...
    render() {
        return (index$1.h("div", { class: "visit-notes", dir: document.documentElement.dir }, index$1.h("div", { class: { "notes-anchors": true, "hidden": !this.showAnchors } }, this.notesExist &&
            index$1.h("button", { onClick: (e) => this.scrollToNotesSection(e, this.notesAnchor) }, this.messages.amwell_visit_notes_notes_title), this.prescriptionsExist &&
            index$1.h("button", { onClick: (e) => this.scrollToNotesSection(e, this.prescriptionsAnchor) }, this.messages.amwell_visit_notes_prescriptions_title), (this.diagnosesExist || this.proceduresExist) &&
            index$1.h("button", { onClick: (e) => this.scrollToNotesSection(e, this.diagnosesAndProceduresAnchor) }, this.messages.amwell_visit_notes_diagnoses_and_procedures_title), (this.agendaItemsExist || this.postVisitItemsExist) &&
            index$1.h("button", { onClick: (e) => this.scrollToNotesSection(e, this.additionalItemsAnchor) }, this.messages.amwell_visit_notes_additional_items_title)), index$1.h("div", { ref: (el) => this.notesSection = el, class: "notes-sections", "data-simplebar-direction": document.documentElement.dir }, !this.notesExist
            && !this.prescriptionsExist
            && !this.diagnosesExist
            && !this.proceduresExist
            && !this.agendaItemsExist
            && !this.postVisitItemsExist &&
            index$1.h("div", { class: "no-notes-placeholder" }, index$1.h("div", { class: "no-notes-icon" }), index$1.h("div", { class: "no-notes-message" }, this.messages.amwell_visit_notes_placeholder)), index$1.h("div", null, this.notesExist &&
            index$1.h(NotesSection, { ref: (el) => this.notesAnchor = el, class: "notes-section", title: this.messages.amwell_visit_notes_notes_title }, index$1.h("div", { innerHTML: this.visit.providerEntries.notes })), this.prescriptionsExist &&
            index$1.h(NotesSection, { ref: (el) => this.prescriptionsAnchor = el, class: "notes-section", title: this.messages.amwell_visit_notes_prescriptions_title }, this.visit.providerEntries.prescriptions.map((prescription) => index$1.h(NotesEntry, { title: prescription.description, description: prescription.rxInstructions }))), (this.diagnosesExist || this.proceduresExist) &&
            index$1.h(NotesSection, { ref: (el) => this.diagnosesAndProceduresAnchor = el, class: "notes-section", title: this.messages.amwell_visit_notes_diagnoses_and_procedures_title }, this.diagnosesExist && this.visit.providerEntries.diagnoses.map((diagnosis) => index$1.h(NotesEntry, { title: diagnosis.displayName, description: diagnosis.description })), this.proceduresExist && this.visit.providerEntries.procedures.map((procedure) => index$1.h(NotesEntry, { title: procedure.displayName, description: procedure.description }))), (this.agendaItemsExist || this.postVisitItemsExist) &&
            index$1.h(NotesSection, { ref: (el) => this.additionalItemsAnchor = el, class: "notes-section", title: this.messages.amwell_visit_notes_additional_items_title }, this.agendaItemsExist && this.visit.providerEntries.agendaItemFollowUps.map((item) => index$1.h(NotesEntry, { description: item.description })), this.postVisitItemsExist && this.visit.providerEntries.postVisitFollowUpItems.map((item) => index$1.h(NotesEntry, { description: item.description })))))));
    }
    static get watchers() { return {
        "visit": ["visitUpdated"]
    }; }
...
exports.amwell_chat_window = ChatWindow;
exports.amwell_guest_invite = GuestInvite;
exports.amwell_tyto_device = TytoDeviceWizard;
exports.amwell_video_console = VideoConsole;
exports.amwell_visit_notes = VisitNotes;
